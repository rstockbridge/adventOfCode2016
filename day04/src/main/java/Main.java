...
public class Main {
    ...
    public static void main(String[] args) {
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader("/Users/rebecca/Desktop/Dropbox/documents/work/coding/AdventOfCode2016/day04/src/main/java/input.txt"))) {
